...
Skill discovery walks configured directories, finds `SKILL.md` files, scores them against the current query, and can build turn-context snippets from the most relevant skills.
